	...
	<div class="card-body">
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<h6 class="mb-2 text-primary">Informasi Pribadi</h6>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="website">Ponsel</label>
					<input type="url" class="form-control" id="website" placeholder="Masukkan nomor ponsel aktif">
				</div>
			</div>
		</div>
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="zIp" placeholder="Masukkan kode pos">
				</div>
			</div>
		</div>
		<div class="row gutters">
